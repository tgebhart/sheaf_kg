...
from sheaf_kg.interactions.multisection_trans_e import MultisectionTransEInteraction
...
class MultisectionTransE(ERModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        super().__init__(
            interaction=MultisectionTransEInteraction,
